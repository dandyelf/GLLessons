...
bool SceneGL::m_transparent = false;
...
QSize SceneGL::minimumSizeHint() const
{
    return QSize(50, 50);
}

QSize SceneGL::sizeHint() const
{
...
void SceneGL::setXRotation(int angle)
{
...
void SceneGL::setYRotation(int angle)
{
    qNormalizeAngle(angle);
    if (angle != m_yRot) {
        m_yRot = angle;
...
void SceneGL::setZRotation(int angle)
{
    qNormalizeAngle(angle);
    if (angle != m_zRot) {
        m_zRot = angle;
